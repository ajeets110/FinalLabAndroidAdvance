...
public class DetailsOfPerson extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!name.getText().toString().equals("") && !lastName.getText().toString().equals("") && !phoneNumber.getText().toString().equals("") && !address.getText().toString().equals("")){
                    ...
                    Toast.makeText(DetailsOfPerson.this,"Person updated",Toast.LENGTH_SHORT).show();
                    finish();

                }

                else {
                    Toast.makeText(DetailsOfPerson.this,"Please fill all fields to update",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        removeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DetailsOfPerson.this);
                builder.setTitle(person.toString() + " will be deleted \nAre you sure?");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //delete person and finish;
                        databaseHelper.deletePerson(person.getPersonId());
                        Toast.makeText(DetailsOfPerson.this,person.toString()+" is deleted",Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
